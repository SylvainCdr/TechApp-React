...
export default function EditMission() {
    ...
    const handleSubmit = async (updatedMission) => {
        try {
            ...
            const q = query(collection(db, "interventionReports"), where("missionId", "==", missionId));
            ...
            console.error("Erreur lors de la mise à jour de la mission ou du rapport d'intervention : ", error);
            Swal.fire({
                title: "Erreur",
